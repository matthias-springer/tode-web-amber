...
args: ["anObject"],
source: "listElement: anObject\x0a\x09listElement := anObject\x0a\x09",
messageSends: [],
referencedClasses: []
}),
smalltalk.PluggableListMorph);
...
args: [],
source: "listEntries\x0a\x09^listEntries\x0a\x09",
messageSends: [],
referencedClasses: []
}),
smalltalk.PluggableListMorph);
...
args: ["anObject"],
source: "listEntries: anObject\x0a\x09listEntries := anObject\x0a\x09",
messageSends: [],
referencedClasses: []
}),
smalltalk.PluggableListMorph);
...
$2=_st($1)._onArrowKeyUp_((function(){
return smalltalk.withContext(function($ctx3) {
...
args: ["html"],
source: "renderOn: html\x0a\x09entry := html li: content.\x0a\x09\x09entry\x0a\x09\x09\x09addClass: 'selectee';\x0a\x09\x09\x09onClick: [entry addClass: 'selected'. entry asJQuery siblings removeClass: 'selected'.\x0a\x09\x09\x09\x09\x09\x09self selected].\x0a\x09",
