...
args: ["aSimilarClass"],
source: "as: aSimilarClass\x0a\x09\x22Create an object of class aSimilarClass that has similar contents to the receiver.\x22\x0a\x0a\x09^ aSimilarClass newFrom: self",
...
args: ["aBlock"],
source: "assert: aBlock\x0a\x09\x22Throw an assertion error if aBlock does not evaluates to true.\x22\x0a\x09\x0a\x09aBlock value ifFalse: [Error signal: 'Assertion failed']",
...
args: ["aParameter"],
source: "changed: aParameter \x0a\x09Transcript show: 'Object>>changed:', aParameter asString, Character cr.\x0a\x09self dependents do: [:aDependent | \x0a\x09\x09Transcript show: '   --> sending to ', aDependent asString, Character cr.\x0a\x09\x09aDependent update: aParameter]",
...
args: [],
source: "isCharacter\x0a\x09^ false",
messageSends: [],
referencedClasses: []
}),
smalltalk.Object);
...
args: ["aNumber"],
source: "codePoint: aNumber\x0a\x09< return String.fromCharCode(aNumber) >",
messageSends: [],
referencedClasses: []
}),
smalltalk.Character.klass);
...
smalltalk.addClass('Color', smalltalk.Object, ['rgb'], 'Kernel-Objects');
smalltalk.addMethod(
smalltalk.method({
...
return smalltalk.withContext(function($ctx1) { 
var $1;
$1=_st(_st(_st(self)._asHexadecimal_(_st(self)._red())).__comma(_st(self)._asHexadecimal_(_st(self)._green()))).__comma(_st(self)._asHexadecimal_(_st(self)._blue()));
return $1;
}, function($ctx1) {$ctx1.fill(self,"forHtml",{},smalltalk.Color)})},
args: [],
source: "forHtml\x0a\x09^(self asHexadecimal: self red), (self asHexadecimal: self green), (self asHexadecimal: self blue)",
messageSends: [",", "asHexadecimal:", "blue", "green", "red"],
referencedClasses: []
}),
smalltalk.Color);
...
return smalltalk.withContext(function($ctx1) { 
var $1;
$1=_st(self)._r_g_b_((0),(1),(1));
return $1;
}, function($ctx1) {$ctx1.fill(self,"cyan",{},smalltalk.Color.klass)})},
args: [],
source: "cyan\x0a\x09^ self r: 0 g: 1 b: 1",
messageSends: ["r:g:b:"],
referencedClasses: []
}),
smalltalk.Color.klass);
...
return smalltalk.withContext(function($ctx1) { 
var $1;
$1=_st(self)._r_g_b_((0.5),(0.5),(0.5));
return $1;
...
return smalltalk.withContext(function($ctx1) { 
var $1;
$1=_st(self)._r_g_b_((1),(0),(1));
return $1;
}, function($ctx1) {$ctx1.fill(self,"magenta",{},smalltalk.Color.klass)})},
args: [],
source: "magenta\x0a\x09^ self r: 1 g: 0 b: 1",
messageSends: ["r:g:b:"],
referencedClasses: []
}),
smalltalk.Color.klass);
...
return smalltalk.withContext(function($ctx1) { 
var $1;
$1=_st(self)._r_g_b_((1),(0),(0));
return $1;
}, function($ctx1) {$ctx1.fill(self,"red",{},smalltalk.Color.klass)})},
args: [],
source: "red\x0a\x09^ self r: 1.0 g: 0.0 b: 0.0",
messageSends: ["r:g:b:"],
referencedClasses: []
}),
smalltalk.Color.klass);
...
return self}, function($ctx1) {$ctx1.fill(self,"<<",{aNumber:aNumber},smalltalk.Number)})},
args: ["aNumber"],
source: "<< aNumber\x0a\x09aNumber < 0 \x0a\x09\x09ifTrue: [Error signal: 'negative arg']\x0a\x09\x09ifFalse: [^ self jsBitShiftLeft: aNumber]",
...
return self}, function($ctx1) {$ctx1.fill(self,">>",{aNumber:aNumber},smalltalk.Number)})},
args: ["aNumber"],
source: ">> aNumber\x0a\x09aNumber < 0 \x0a\x09\x09ifTrue: [Error signal: 'negative arg']\x0a\x09\x09ifFalse: [^ self jsBitShiftRight: aNumber]",
...
args: [],
source: "asCharacter\x0a\x09^ Character codePoint: self",
messageSends: ["codePoint:"],
...
args: [],
source: "asHexadecimal\x0a\x09\x22returns the number as hexadecimal string\x22\x0a\x09<return self.toString(16)>",
messageSends: [],
referencedClasses: []
}),
smalltalk.Number);
...
var self=this;
return smalltalk.withContext(function($ctx1) { 
return numBitShiftLeft(self, aNumber);
return self}, function($ctx1) {$ctx1.fill(self,"jsBitShiftLeft:",{aNumber:aNumber},smalltalk.Number)})},
args: ["aNumber"],
source: "jsBitShiftLeft: aNumber\x0a\x09\x22Inlined in the Compiler\x22\x0a\x09<return numBitShiftLeft(self, aNumber)>",
messageSends: [],
referencedClasses: []
}),
smalltalk.Number);
...
var self=this;
return smalltalk.withContext(function($ctx1) { 
return numBitShiftRight(self, aNumber);
return self}, function($ctx1) {$ctx1.fill(self,"jsBitShiftRight:",{aNumber:aNumber},smalltalk.Number)})},
args: ["aNumber"],
source: "jsBitShiftRight: aNumber\x0a\x09\x22Inlined in the Compiler\x22\x0a\x09<return numBitShiftRight(self, aNumber)>",
messageSends: [],
referencedClasses: []
}),
smalltalk.Number);
...
return smalltalk.withContext(function($ctx1) { 
var $1;
$1=_st(_st(self)._min_(aMin))._max_(aMax);
return $1;
}, function($ctx1) {$ctx1.fill(self,"min:max:",{aMin:aMin,aMax:aMax},smalltalk.Number)})},
args: ["aMin", "aMax"],
source: "min: aMin max: aMax \x0a\x0a\x09^ (self min: aMin) max: aMax",
...
args: ["aPoint"],
source: "corner: aPoint \x0a\x09\x22Answer a Rectangle whose origin is the receiver and whose corner is \x0a\x09aPoint. This is one of the infix ways of expressing the creation of a \x0a\x09rectangle.\x22\x0a\x0a\x09^Rectangle origin: self corner: aPoint",
...
args: ["key", "aBlock"],
source: "at: key ifAbsent: aBlock\x0a\x09\x22Answer the value associated with the key or, if key isn't found, answer the result of evaluating aBlock.\x22\x0a\x0a\x09| v |\x0a\x09(v := self at: key) ifNil: [^ aBlock value].\x0a\x09^ v",
...
args: ["key", "aBlock"],
source: "at: key ifPresent: aBlock\x0a\x09\x22Lookup the given key in the receiver. If it is present, answer the value of evaluating the given block with the value associated with the key. Otherwise, answer nil.\x22\x0a\x0a\x09| v |\x0a\x09v := self at: key ifAbsent: [^ nil].\x0a\x09^ aBlock value: v",
messageSends: ["at:ifAbsent:", "value:"],
referencedClasses: []
}),
smalltalk.Smalltalk);
...
args: [],
source: "globals\x0a\x09|classes|\x0a\x09classes := Dictionary new.\x0a\x09Smalltalk current classes do: [:clazz | \x0a\x09\x09classes at: clazz name put: clazz].\x0a\x09^ classes",
messageSends: ["new", "do:", "at:put:", "name", "classes", "current"],
referencedClasses: ["Dictionary", "Smalltalk"]
}),
smalltalk.Smalltalk);
